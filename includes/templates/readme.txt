...
Of study, templates are not required. You can just build screens in your plugin files with HTML.
However, this reduces flexbility for end users.

For more information, see the functions bp_study_load_template_filter() for how template locations
are filtered, and bp_study_screen_one() for how they are loaded for a screen (all in bp-study-core.php)